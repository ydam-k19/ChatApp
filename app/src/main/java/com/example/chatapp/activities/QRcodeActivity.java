...
public class QRcodeActivity extends AppCompatActivity {
    ...
    public class MyImageAnalyzer implements ImageAnalysis.Analyzer {
        ...
        private void scanbarcode(ImageProxy image) {
            ...
            BarcodeScannerOptions options = new BarcodeScannerOptions.Builder().setBarcodeFormats(Barcode.FORMAT_QR_CODE, Barcode.FORMAT_AZTEC, Barcode.FORMAT_ALL_FORMATS).build();
